angular.module('servoysampleScTextField', ['servoy', 'ngMaterial']).directive('servoysampleScTextField', ['$svyProperties', '$sabloConstants', function($svyProperties, $sabloConstants) {
		return {
			restrict: 'E',
			scope: {
				model: '=svyModel',
			...
			templateUrl: 'servoysample/scTextField/scTextField.html'
		};
	}]).directive('servoysampleSctextfieldTemplate', ["$compile", function($compile) {
		return {
			restrict: 'E',
