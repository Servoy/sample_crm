angular.module('servoysampleScSearchbar', ['servoy', 'ngMaterial']).directive('servoysampleScSearchbar', ['$timeout', '$q', '$utils', '$parse', function($timeout, $q, $utils, $parse) {
		return {
			restrict: 'E',
			scope: {
				model: '=svyModel',
			...
			templateUrl: 'servoysample/scSearchbar/scSearchbar.html'
		};
	}])